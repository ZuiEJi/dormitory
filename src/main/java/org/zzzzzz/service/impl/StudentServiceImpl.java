...
public class StudentServiceImpl implements StudentService {
    ...
    public int listStudentCount(){
        return this.studentMapper.listStudentCount();
    }

    public List<Student> listPage(@Param("index") int index, @Param("showdate") int showdate){
         return this.studentMapper.listPage(index,showdate);
    }

    @Override
    public int listMovecount() {
        return this.studentMapper.listmovecount();
    }

    @Override
    public List<Student> list_movepage(int index, int showdate) {
        return this.studentMapper.list_movepage(index,showdate);
    }

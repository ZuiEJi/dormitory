            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="radio-inline">
                        <input type="radio" name="type" checked value="systemAdmin" class="radio-inline"> 管理员
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="type" value="dormitoryAdmin" class="radio-inline" > 宿管
                    </label>
                    <label class="radio-inline">
                    <input type="radio" name="type" value="studentAdmin" class="radio-inline" > 学生
                    </label>
                </div>

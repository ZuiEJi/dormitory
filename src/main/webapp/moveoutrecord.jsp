                ...
                <div class="pagination-container">
                    <ul class="pagination">
                        <c:if test="${pageindex > 1}">
                            <li><a href="/moveout/record?pageindex=1">首页</a></li>
                            <li><a href="/moveout/record?pageindex=${pageindex - 1}">上一页</a></li>
                        </c:if>
                        <c:forEach begin="1" end="${pagecount}" var="i">
                            <li class="${i == pageindex ? 'active' : ''}"><a href="/moveout/record?pageindex=${i}">${i}</a></li>
                        </c:forEach>
                        <c:if test="${pageindex < pagecount}">
                            <li><a href="/moveout/recordpageindex=${pageindex + 1}">下一页</a></li>
                            <li><a href="/moveout/record?pageindex=${pagecount}">尾页</a></li>
                        </c:if>
                    </ul>

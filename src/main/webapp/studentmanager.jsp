                ...
                <div class="pagination-container">
                    <ul class="pagination">
                        <c:if test="${pageindex > 1}">
                            <li><a href="/student/list?pageindex=1">首页</a></li>
                            <li><a href="/student/list?pageindex=${pageindex - 1}">上一页</a></li>
                        </c:if>
                        <c:forEach begin="1" end="${pagecount}" var="i">
                            <li class="${i == pageindex ? 'active' : ''}"><a href="/student/list?pageindex=${i}">${i}</a></li>
                        </c:forEach>
                        <c:if test="${pageindex < pagecount}">
                            <li><a href="/student/list?pageindex=${pageindex + 1}">下一页</a></li>
                            <li><a href="/student/list?pageindex=${pagecount}">尾页</a></li>
                        </c:if>
                    </ul>
